...
public class MainLayout extends AppLayout implements LocaleChangeObserver {
	...
	private void createDrawer() {
		if (this.securityService.getAuthenticatedUser() != null) {
			this.ageGroupRouterLink = new RouterLink(this.getTranslation("age.group.pl"), AgeGroupView.class);
			...
			this.locationRouterLink = new RouterLink(this.getTranslation("location.pl"), LocationView.class);
			this.streetRouterLink = new RouterLink(this.getTranslation("street.pl"), StreetView.class);
			this.addToDrawer(new VerticalLayout(this.ageGroupRouterLink, this.cityRouterLink, this.clubRouterLink, this.countryRouterLink, this.genderRouterLink, this.locationRouterLink, this.streetRouterLink));
		}
		...
		this.addToDrawer(new VerticalLayout(this.gameRouterLink, this.gymRouterLink, this.rankingLink, this.teamRouterLink));
	}
